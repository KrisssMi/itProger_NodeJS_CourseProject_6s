...
class NavBar extends Component {
  onLogoutClick(e) {  // метод для выхода из аккаунта
    e.preventDefault();
        ...
        if(users.role == 'instructor')
          {
            var authLinks = (
              ...
              <a href={`${process.env.PUBLIC_URL}/finaldashboard`}>
                ...
                <li>
                  <a href={`${process.env.PUBLIC_URL}/finalprofiles`}>
                    ALL PROFILES
                  </a>
                </li>
              {/* <li>
                      ...
                      <div
                        ...
                        <nav className="main-nav">
                          ...
                          <ul id="main-nav-ul">
                            ...
                            {isAuthenticated ? authLinks : guestLinks}  {/* if user is logged in then show authLinks else show guestLinks */}
                          </ul>
                          <div
...
NavBar.propTypes = {  // to check if the props are passed correctly

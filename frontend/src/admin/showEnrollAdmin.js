...
export default class EnrollList extends Component {
    ...
    render() {
        ...
        <div>
               ...
               <a href="/createEnrollAdmin" className="btn btn-outline-info" role="button" aria-pressed="true">Create Enrollment</a> <br/>

                <h1 style={{marginLeft:"-200px", color:"#a5c41a"}}>Enrollment List</h1>
